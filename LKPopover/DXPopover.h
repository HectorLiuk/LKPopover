...
/**
 *  The popover arrow size, default is {10.0, 10.0};箭头
 */
@property (nonatomic, assign) CGSize arrowSize;

/**
 *  The popover corner radius, default is 7.0;边角弧度
 */
@property (nonatomic, assign) CGFloat cornerRadius;

/**
 *  The popover animation show in duration, default is 0.4;动画持续时间
 */
@property (nonatomic, assign) CGFloat animationIn;

/**
 *  The popover animation dismiss duration, default is 0.3;消失
 */
...
/**
 * Decide the nearest edge between the containerView's border and popover, default is 4.0  离屏幕边缘距离
 */
